...
final class JacksonSerializersV0 {
  ...
  private static Optional<String> id(Object obj) {
    if (obj instanceof FacilityV0) {
      return Optional.ofNullable(((FacilityV0) obj).id());
    }
  ...
  static SimpleModule serializersV0() {
    ...
    mod.addSerializer(FacilityV0.Address.class, new AddressSerializer());
    mod.addSerializer(FacilityV0.Addresses.class, new AddressesSerializer());
    mod.addSerializer(
        FacilitiesResponse.FacilitiesMetadata.class, new FacilitiesMetadataSerializer());
    mod.addSerializer(FacilityV0.FacilityAttributes.class, new FacilityAttributesSerializer());
    mod.addSerializer(FacilityV0.Hours.class, new HoursSerializer());
    mod.addSerializer(FacilityV0.PatientWaitTime.class, new PatientWaitTimeSerializer());
    mod.addSerializer(FacilityV0.Phone.class, new PhoneSerializer());
    mod.addSerializer(FacilityV0.Satisfaction.class, new SatisfactionSerializer());
    mod.addSerializer(FacilityV0.Services.class, new ServicesSerializer());
    mod.addSerializer(FacilityV0.WaitTimes.class, new WaitTimesSerializer());
  ...
  private static final class AddressSerializer extends StdSerializer<FacilityV0.Address> {
    public AddressSerializer() {
      this(null);
    }

    public AddressSerializer(Class<FacilityV0.Address> t) {
      super(t);
    }

    private static boolean empty(FacilityV0.Address value) {
    ...
    private static boolean emptyExcludeAddr1(FacilityV0.Address value) {
      return value.zip() == null
          && value.city() == null
          && value.state() == null
          && value.address2() == null
    ...
    public void serialize(
        FacilityV0.Address value, JsonGenerator jgen, SerializerProvider provider) {
  ...
  private static final class AddressesSerializer extends StdSerializer<FacilityV0.Addresses> {
    public AddressesSerializer() {
      this(null);
    }

    public AddressesSerializer(Class<FacilityV0.Addresses> t) {
      super(t);
    }

    private static boolean empty(FacilityV0.Addresses value) {
    ...
    @SneakyThrows
    public void serialize(
        FacilityV0.Addresses value, JsonGenerator jgen, SerializerProvider provider) {
      jgen.writeStartObject();
      if (!empty(value)) {
        jgen.writeObjectField(
            "mailing",
            Optional.ofNullable(value.mailing()).orElse(FacilityV0.Address.builder().build()));
        jgen.writeObjectField(
            "physical",
            Optional.ofNullable(value.physical()).orElse(FacilityV0.Address.builder().build()));
      }
      jgen.writeEndObject();
    }
  }
  ...
  private static final class FacilityAttributesSerializer
      extends StdSerializer<FacilityV0.FacilityAttributes> {
    public FacilityAttributesSerializer() {
      this(null);
    }

    public FacilityAttributesSerializer(Class<FacilityV0.FacilityAttributes> t) {
      super(t);
    }
    ...
    @SneakyThrows
    public void serialize(
        FacilityV0.FacilityAttributes value, JsonGenerator jgen, SerializerProvider provider) {
      jgen.writeStartObject();
      ...
      jgen.writeObjectField(
          "address",
          Optional.ofNullable(value.address()).orElse(FacilityV0.Addresses.builder().build()));
      jgen.writeObjectField(
          "phone", Optional.ofNullable(value.phone()).orElse(FacilityV0.Phone.builder().build()));
      jgen.writeObjectField(
          "hours", Optional.ofNullable(value.hours()).orElse(FacilityV0.Hours.builder().build()));
      jgen.writeObjectField(
          "operational_hours_special_instructions", value.operationalHoursSpecialInstructions());
      jgen.writeObjectField(
          "services",
          Optional.ofNullable(value.services()).orElse(FacilityV0.Services.builder().build()));
      jgen.writeObjectField(
          "satisfaction",
          Optional.ofNullable(value.satisfaction())
              .orElse(FacilityV0.Satisfaction.builder().build()));
      jgen.writeObjectField(
          "wait_times",
          Optional.ofNullable(value.waitTimes()).orElse(FacilityV0.WaitTimes.builder().build()));
  ...
  private static final class HoursSerializer extends StdSerializer<FacilityV0.Hours> {
    public HoursSerializer() {
      this(null);
    }

    public HoursSerializer(Class<FacilityV0.Hours> t) {
      super(t);
    }

    private static boolean empty(FacilityV0.Hours value) {
    ...
    private static void writeLower(FacilityV0.Hours value, JsonGenerator jgen) {
    ...
    private static void writeLowerByLength(FacilityV0.Hours value, JsonGenerator jgen) {
      writeNonNull(jgen, "friday", value.friday());
      writeNonNull(jgen, "monday", value.monday());
      writeNonNull(jgen, "sunday", value.sunday());
      writeNonNull(jgen, "tuesday", value.tuesday());
    ...
    private static void writeUpper(FacilityV0.Hours value, JsonGenerator jgen) {
      writeNonNull(jgen, "Monday", value.monday());
      writeNonNull(jgen, "Tuesday", value.tuesday());
      writeNonNull(jgen, "Wednesday", value.wednesday());
      writeNonNull(jgen, "Thursday", value.thursday());
    ...
    private static void writeUpperByLength(FacilityV0.Hours value, JsonGenerator jgen) {
      writeNonNull(jgen, "Friday", value.friday());
      writeNonNull(jgen, "Monday", value.monday());
      writeNonNull(jgen, "Sunday", value.sunday());
      writeNonNull(jgen, "Tuesday", value.tuesday());
    ...
    @Override
    @SneakyThrows
    public void serialize(FacilityV0.Hours value, JsonGenerator jgen, SerializerProvider provider) {
      jgen.writeStartObject();
      if (!empty(value)) {
        if (hasParent(jgen, FacilityReadResponse.class)) {
          writeLower(value, jgen);
        } else if (hasParent(jgen, FacilityV0.class)) {
  ...
  private static final class PatientWaitTimeSerializer
      extends StdSerializer<FacilityV0.PatientWaitTime> {
    public PatientWaitTimeSerializer() {
      this(null);
    }

    public PatientWaitTimeSerializer(Class<FacilityV0.PatientWaitTime> t) {
      super(t);
    }
    ...
    @SneakyThrows
    public void serialize(
        FacilityV0.PatientWaitTime value, JsonGenerator jgen, SerializerProvider provider) {
      jgen.writeStartObject();
  ...
  private static final class PhoneSerializer extends StdSerializer<FacilityV0.Phone> {
    public PhoneSerializer() {
      this(null);
    }

    public PhoneSerializer(Class<FacilityV0.Phone> t) {
      super(t);
    }

    private static boolean empty(FacilityV0.Phone value) {
    ...
    @Override
    @SneakyThrows
    public void serialize(FacilityV0.Phone value, JsonGenerator jgen, SerializerProvider provider) {
      jgen.writeStartObject();
      if (!empty(value)) {
  ...
  private static final class SatisfactionSerializer extends StdSerializer<FacilityV0.Satisfaction> {
    public SatisfactionSerializer() {
      this(null);
    }

    public SatisfactionSerializer(Class<FacilityV0.Satisfaction> t) {
      super(t);
    }

    private static boolean empty(FacilityV0.Satisfaction value) {
    ...
    @SneakyThrows
    public void serialize(
        FacilityV0.Satisfaction value, JsonGenerator jgen, SerializerProvider provider) {
      jgen.writeStartObject();
      if (!empty(value) || idStartsWith(jgen, "vha_")) {
        jgen.writeObjectField(
            "health",
            Optional.ofNullable(value.health())
                .orElse(FacilityV0.PatientSatisfaction.builder().build()));
  ...
  private static final class ServicesSerializer extends StdSerializer<FacilityV0.Services> {
    public ServicesSerializer() {
      this(null);
    }

    public ServicesSerializer(Class<FacilityV0.Services> t) {
      super(t);
    }
    ...
    @SneakyThrows
    public void serialize(
        FacilityV0.Services value, JsonGenerator jgen, SerializerProvider provider) {
      jgen.writeStartObject();
  ...
  private static final class WaitTimesSerializer extends StdSerializer<FacilityV0.WaitTimes> {
    public WaitTimesSerializer() {
      this(null);
    }

    public WaitTimesSerializer(Class<FacilityV0.WaitTimes> t) {
      super(t);
    }

    private static boolean empty(FacilityV0.WaitTimes value) {
      return value.health() == null && value.effectiveDate() == null;
    }
    ...
    @SneakyThrows
    public void serialize(
        FacilityV0.WaitTimes value, JsonGenerator jgen, SerializerProvider provider) {
      jgen.writeStartObject();
      if (!empty(value) || idStartsWith(jgen, "vha_")) {
        jgen.writeObjectField("health", Optional.ofNullable(value.health()).orElse(emptyList()));
        jgen.writeObjectField("effective_date", value.effectiveDate());
